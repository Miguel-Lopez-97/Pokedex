...
const url = [
  ...
  "https://pokeapi.co/api/v2/pokemon/?offset=809&limit=96", // Correct Gen 8 (Galar + Hisui: 810-905)
  "https://pokeapi.co/api/v2/pokemon/?offset=905&limit=120", // Correct Gen 9 (Paldea + DLC: 906-1025)
  "https://pokeapi.co/api/v2/pokemon/?offset=1025&limit=10000" // Alternative Forms
];
    ...
    <HashRouter>
      <Routes>
        <Route path='/' element={<Header />}>
          ...
          <Route path="/ninth_gen" element={<ApiGen urlApi={url[8]} Gen="Paldea - Ninth" />} />
          <Route path="/alternative_forms" element={<ApiGen urlApi={url[9]} Gen="Alternative Forms" />} />
